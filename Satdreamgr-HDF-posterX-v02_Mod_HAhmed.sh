...
cd /tmp
set -e 
 wget "https://raw.githubusercontent.com/Ham-ahmed/SatDreamGr/main/Satdreamgr-HDF-posterX-v02_Mod_HAhmed.tar.gz"
wait
tar -xzf Satdreamgr-HDF-posterX-v02_Mod_HAhmed.tar.gz  -C /
wait
cd ..
set +e
rm -f /tmp/Satdreamgr-HDF-posterX-v02_Mod_HAhmed.tar.gz
sleep 2;
echo "" 
echo "" 
echo "**************************************************************************************************"
